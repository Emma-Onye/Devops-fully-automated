#!/bin/bash
# Hardware requirements: Ubuntu 20.04 instance with minimum t2.micro type instance & port 3000 (grafana), 9100 (node-exporter) should be allowed on the security groups
...
sudo git clone -b installations https://github.com/Emma-Onye/devops-fully-automated.git /tmp/devops-fully-automated
